...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <!-- Form -->
                <form id="jquery-val-form" class="form form-horizontal mt-2" enctype="multipart/form-data"
                    method="POST" @if (isset($book)) action="{{ route('books.update',$book->id) }}" @else
                    ...
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="form-group mb-2">
                                ...
                                <input type="text" name="urdu_name" id="blog-edit-title" class="form-control"
                                    @if(isset($book)) value="{{old('title', $book->title)}}" @else
                                    value="{{ old('urdu_name') }}" @endif required />
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group mb-2">
                                ...
                                <input type="text" name="english_name" id="blog-edit-title" class="form-control"
                                    @if(isset($book)) value="{{old('title', $book->title)}}" @else
                                    value="{{ old('english_name') }}" @endif required />
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group mb-2">
                                ...
                                <input type="text" name="author" id="author" class="form-control"
                                    ...
                                    value="{{ old('author') }}" @endif required />
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group mb-2">
                                <label for="publications_name">Publications Name</label>
                                <input type="text" name="publications_name" id="publications_name" class="form-control"
                                    @if(isset($book)) value="{{old('publications_name', $book->publications_name)}}" @else
                                    value="{{ old('publications_name') }}" @endif required />
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group mb-2">
                                ...
                                <input type="text" name="quantity" id="quantity" class="form-control"
                                    ...
                                    value="{{ old('quantity') }}" @endif required />
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group mb-2">
                                ...
                                <input type="text" name="price" id="price" class="form-control"
                                    ...
                                    value="{{ old('price') }}" @endif required />
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group mb-2">
                                ...
                                <input type="text" name="discounted_price" id="discounted_price" class="form-control"
                                    ...
                                    value="{{ old('discounted_price') }}" @endif required />
                            </div>
                        </div>
                                ...
                                <div class="border rounded p-2">
                                    ...
                                    <div class="image">
                                        <div class=" col-md-6 input">
                                            ...
                                            <input type="file" name="file" class="form-control" @if (isset($book)) data-id="{{ $book->image }}"
                                                @endif name="file" accept=".png, .jpg, .jpeg">
                                        </div>
                                        @if (isset($book) && $book->image)
                                        <div class="row mt-1">
                                            <div class="col-sm-3">
                                                <div class="card">
                                                    <img src="{{asset('storage/books/'.$book->image)}}" alt="post Image" />
                                                    <a onclick="deleteImage(this)" data-id="{{ $book->image }}"
                                                        class="btn btn-outline-danger text-danger" style="border-radius:0;">Remove</a>
                                                </div>
                                            </div>
                                        </div>
                                        @endif
                        ...
                        <div class="col-md-12 mt-50 mb-2">
                            <button type="submit" class="btn btn-primary mr-1">@if (isset($book))Save Changes @else Save
                                @endif</button>
